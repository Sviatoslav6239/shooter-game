...
class GameSprite(sprite.Sprite):
    def __init__(self, sprite_image, x, y, width, height, speed):
        ...
        self.shield_image = transform.scale(image.load("images/2_5366403259432981713.png"), (width, width))
...
class Enemy(GameSprite):
    ...
    def spawn_bonus(self):
        ...
        if chance <= self.shield_bonus_chance:
            bonus = Bonus("shield", "images/2_5366403259432981713.png", self.rect.centerx - 25, self.rect.top)
...
class CommonUfo(Enemy):
    ...
    def death(self):
        ...
        self.respawn(3)
        score += 1
        text_score = font_interface.render("Захунок: " + str(score), True, (255, 255, 255))
...
mixer.music.load("sounds/phonk1.ogg")
mixer.music.play(-1)
...
bonus = Bonus("shield", "images/2_5366403259432981713.png", 100, 200)
bonuses_group.add(bonus)
...
text_lose = font_finish.render("Програв!", True, (200, 255, 255))
...
while game:
    ...
    hit_list_asteroid = sprite.groupcollide(asteroids_group, bullets_group, False, True)

    if not player.alive or lost >= 30:
        finish = True
